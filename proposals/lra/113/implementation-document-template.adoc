...
The new client will use the RESTEasy implementation of the Microprofile REST client: https://microprofile.io/specifications/microprofile-rest-client/ .  
...
- Implement a ClientRequestFilter to add the JWT token
