...
* Implement a new LRA client API using the reasteasy implementation of the MicroProfile REST Client 
...
* This proposal relies on underlying framework to guarantee the integrity of requests/responses (HTTPS, JWT or TLS) so this proposal will not cover that area.
