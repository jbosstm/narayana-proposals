...
* Implement a new LRA client API using MicroProfile REST Client specification
...
* Make the client auto-closeable to improve resource management (addresses issue #157)
